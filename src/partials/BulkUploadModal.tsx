  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-6 py-4 shrink-0">
        <div>
          {step === 1 && (
            <Button semantic="neutral" hierarchy="tertiary" onClick={handleClose}>
              Cancel
            </Button>
          )}
          {step === 2 && (
            <Button semantic="neutral" hierarchy="secondary" onClick={handleBack}>
              Back
            </Button>
          )}
        </div>
        ...
        <div>
          ...
          {step === 2 && (
            <Button disabled={!allMapped || isSubmitting} onClick={handleUpload}>
...
export function BulkUploadModal({ open, onClose }: BulkUploadModalProps) {
  ...
  return (
    <BulkUploadProvider onClose={onClose}>
